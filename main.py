...
# DuckDB connection - Render pe persistent storage ke liye
con = duckdb.connect(database='/tmp/hitek.duckdb')  # /tmp use karo Render pe
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "message": "API is running on Render!"}

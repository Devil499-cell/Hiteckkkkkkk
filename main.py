...
HF_INDEX_BASE = os.environ.get(
    "ICMR_HF_INDEX_BASE",
    "https://huggingface.co/datasets/rkniloy/icrm-hitek-full-db-mixed/resolve/main",  # <-- UPDATED DATASET
).rstrip("/")
...
# Remote indexes (using new dataset)
REMOTE_INDEXES = {
...
**Source:** [HF Dataset](https://huggingface.co/datasets/rkniloy/icrm-hitek-full-db-mixed)
            """)
